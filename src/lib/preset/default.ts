...
function entry(...classes: readonly ClassValue[]): PresetEntry {
	const record = Object.freeze({ class: Object.freeze(classes) });
	return () => record;
}
...
const styledEntries = {
	...
	'input.color': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.currency': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.date': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.datetime': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.email': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.file': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.location': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.number': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.otp': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.password': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.phone': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.text': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.time': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.url': entry(interaction.focus, interaction.control, 'text-sm'),
	'input.icon': entry(),
