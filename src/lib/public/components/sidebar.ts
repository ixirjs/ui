export { Sidebar, animateSidebarContent } from '$ixirjs/ui/components/sidebar';
export type * from '$ixirjs/ui/components/sidebar/types';

// The parts by name, beside the namespace. `<Sidebar.Root>` is a member expression — a DYNAMIC
...
export { SidebarRoot, SidebarContent } from '$ixirjs/ui/components/sidebar';
