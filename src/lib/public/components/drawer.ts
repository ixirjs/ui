export { Drawer } from '$ixirjs/ui/components/drawer';
export type * from '$ixirjs/ui/components/drawer/types';

// The parts by name, beside the namespace. `<Drawer.Root>` is a member expression — a DYNAMIC
...
export {
	...
	DrawerDescription,
	DrawerBackdrop
} from '$ixirjs/ui/components/drawer';
