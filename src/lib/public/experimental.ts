...
// Component state contracts. Popup-family names are interfaces only, not constructors.
...
export type { ComboboxBond } from '$ixirjs/ui/components/combobox/bond.svelte';
export type { ContextMenuBond } from '$ixirjs/ui/components/context-menu/bond.svelte';
export { DataGridBond } from '$ixirjs/ui/components/datagrid/bond.svelte';
export type { DatePickerBond } from '$ixirjs/ui/components/date-picker/bond.svelte';
...
export type { DropdownMenuBond } from '$ixirjs/ui/components/dropdown-menu/bond.svelte';
...
export type { PopoverBond } from '$ixirjs/ui/components/popover/bond.svelte';
export type { PopoverDialogBond } from '$ixirjs/ui/components/popover-dialog/bond.svelte';
...
export type { SelectBond } from '$ixirjs/ui/components/select/bond.svelte';
...
export type { TooltipBond } from '$ixirjs/ui/components/tooltip/bond.svelte';
...
// Canonical popup authoring: one runtime, with family-named interface views.
export { PopupBond } from '$ixirjs/ui/components/overlay/popup/bond.svelte';
export { CollectionItemAtom, menuItem, selectItem } from '$ixirjs/ui/components/overlay/popup/item';
export {
	isDropdownMenuBond,
	isSelectBond,
	isComboboxBond,
...
export type { PopupFamily, PopupProfile } from '$ixirjs/ui/components/overlay/popup/profiles';
