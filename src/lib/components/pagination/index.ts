export * as Pagination from './atoms';
...
// The same parts, named directly. `<Pagination.Root>` is a member expression, so the compiler treats it as a
...
export { default as PaginationRoot } from './pagination-root.svelte';
