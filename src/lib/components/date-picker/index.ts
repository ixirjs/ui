...
// The same parts, named directly. `<DatePicker.Root>` is a member expression, so the compiler treats it as a
...
export { default as DatePickerCalendar } from './date-picker-calendar.svelte';
