<script module>
	...
	import { ScrollableBond } from '$ixirjs/ui/components/scrollable/bond.svelte';
	...
	const { Story } = defineMeta({
		...
		argTypes: {
			disabled: {
				control: 'boolean',
				description: 'Disable scrollbar interaction'
			},
			open: {
				control: 'boolean',
				description: 'Force the custom scrollbar tracks to be visible'
			}
		}
	});
</script>
