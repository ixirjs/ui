...
// The same parts, named directly. `<Sidebar.Root>` is a member expression, so the compiler treats it as a
...
export { default as SidebarRoot } from './sidebar-root.svelte';
